...
- (void)setupMainView
{
    UIImageView *titleImgView = [[UIImageView alloc]initWithFrame:self.bounds];
...
- (void)setupPageControl
{
    ...
    //if (self.imagePathsGroup.count) {
       // NSString *userurl = _imagePathsGroup[indexOnPageControl];
        //[self sd_setImageWithURL:[NSURL URLWithString:userurl]];
    //}
}
...
//        NSString *urlstr = self.imagePathsGroup[index];
...
#pragma mark -
- (void)setSubViewHidden:(BOOL)subViewHidden{
    _subViewHidden = subViewHidden;
//    if (subViewHidden==NO) {
//        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.8 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//            self.mainView.hidden = subViewHidden;
//        });
//
//    }else{
//    self.mainView.hidden = subViewHidden;
//
//    //}
//    self.pageControl.hidden = subViewHidden;
